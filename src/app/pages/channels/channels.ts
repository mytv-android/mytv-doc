...
@Component({
  ...
  template: `
    <div class="doc-page">
      <doc-page-header
        title="频道、收藏与搜索"
        lead="频道列表、跨组切换、加密分组、收藏夹与搜索的完整说明。"
      />
      ...
      <ul>
        ...
        <li><b>备份</b>：随云同步或 10591 面板 <code>/api/configs</code> 备份 / 恢复。</li>
      </ul>

      <h2>隐藏频道与分组</h2>
      <ul>
        <li><b>分类隐藏</b>：<b>设置 → 订阅源 → 分类隐藏</b>，4 列网格逐组切换可见性。</li>
        <li><b>隐藏频道规则</b>：<b>设置 → 订阅源 → 隐藏频道规则</b>，按频道名<b>正则</b>匹配；命中的频道不会出现在列表 / 搜索中。支持添加 / 删除多条正则。</li>
      </ul>
      ...
      <ul>
        ...
        <li><b>算法</b>：
          <ul>
            ...
            <li>输入 ASCII → 把频道名转<b>拼音首字母</b>后匹配（基于 promeg/Pinyin）。</li>
          </ul>
        </li>
        <li><b>防抖</b>：200ms。</li>
      ...
      <h2>频道别名</h2>
      <p>
        不同订阅源对同一频道常起名不一致（"CCTV-1" vs "CCTV1 综合"）。可在 10591 web 面板编辑<b>频道别名</b>，
