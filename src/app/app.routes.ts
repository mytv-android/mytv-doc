...
export const routes: Routes = [
  ...
  },
  {
    ...
    title: 'WebView 播放器 · mytv-android 使用文档',
  },
  {
    path: 'remote-panel',
    loadComponent: () =>
    ...
    title: '远程配置面板（10591）· mytv-android 使用文档',
  },
  {
    ...
    title: '播放器与字幕设置 · mytv-android 使用文档',
  },
  {
    path: 'settings',
    loadComponent: () =>
